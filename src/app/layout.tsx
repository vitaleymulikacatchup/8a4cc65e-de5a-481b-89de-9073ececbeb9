...
export const metadata: Metadata = {
  title: "Ресторан морепродуктов Окунь - Изысканная кухня и свежие морепродукты",
  description: "Ресторан Окунь предлагает изысканные блюда из свежайших морепродуктов в элегантной атмосфере. Бронируйте столик для незабываемого гастрономического опыта.",
  keywords: "ресторан, морепродукты, рыба, окунь, изысканная кухня, свежие продукты, бронирование столика",
  openGraph: {
    title: "Ресторан морепродуктов Окунь - Изысканная кухня и свежие морепродукты",
    description: "Откройте для себя изысканные морепродукты в атмосфере элегантности и комфорта",
    siteName: "Ресторан Окунь",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763732647582-ez7fsec4.jpg",
      alt: "Ресторан Окунь"
    }]
  },
  twitter: {
    ...
    description: "Изысканные морепродукты в элегантной атмосфере",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763732647582-ez7fsec4.jpg"]
  },
  robots: {
    index: true,
    follow: true
